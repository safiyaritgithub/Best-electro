          ...
          <div className="flex flex-wrap -mx-4 lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <h2 className="mb-3 sm:mb-3 font-bold uppercase text-dark text-[26px] sm:text-[26px] lg:text-[36px] xl:text-[40px]">
                  GET IN TOUCH WITH US
                </h2>
                <p className="text-base leading-relaxed mb-6 sm:mb-9 text-body-color">
                  Your feedback, complaints, and suggestions are crucial in
                  helping us improve our services and meet your expectations. We
                  are here to listen and address your concerns, so please don't
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    <h4 className="mb-1 text-lg sm:text-xl font-bold text-dark">
                      Our Location
                    </h4>
                    <p className="text-base text-body-color">
                      H.No: 3-50, Hanuman temple street, Pedda amberpet,
                      Hyderabad, 501505
                    </p>
                  </div>
                </div>
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <a
                      ...
                      href="tel:+919505629940"
                    >
                      (+91) 95056 29940
                    </a>
                  </div>
                </div>
                <div className="mb-2 sm:mb-8 flex w-full max-w-[370px]">
                  <div className="mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-primary bg-opacity-5 text-primary sm:h-[70px] sm:max-w-[70px]">
                    <svg
                      width={28}
                      height={19}
                  ...
                  <div className="w-full">
                    ...
                    <a
                      className="text-base text-body-color underline"
                      href="mailto:contact@bestelectro.in"
                    >
            ...
            <div className="mt-0 sm:mt-20 w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="relative p-8 bg-white rounded-lg shadow-lg sm:p-12">
                ...
                >
                  ...
                  <input
                    type="hidden"
                    name="_next"
                    value="https://www.bestelectro.in/thank-you"
                  />
